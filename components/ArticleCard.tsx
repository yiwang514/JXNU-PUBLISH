    ...
    >
      ...
      >
        ...
        <CardFooter className={cn(
          ...
          isCompactNoCover
            ? (timing.state === 'active' ? 'py-2.5' : 'h-11 py-0')
            : (timing.state === 'active' ? 'py-2' : 'h-12 py-0'),
          ...
          {timing.state === 'active' ? (
            ...
            <>
              <div className={cn(
                'flex items-center gap-2 leading-none text-muted-foreground font-medium min-w-0',
              ...
              {timing.state === 'upcoming' ? (
                ...
                <div className="flex items-center gap-1 text-primary font-bold text-[10px] uppercase tracking-tight shrink-0 whitespace-nowrap opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all transform translate-x-0 md:translate-x-2 md:group-hover:translate-x-0">
                  <span>阅读全文</span>
